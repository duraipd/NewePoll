          ...
          <div className="droptable">
            ...
            {loading ? (
              ...
              <div>
                ...
                {formSubmitted && <div className="error-message">{selectedOptionError}</div>}
                  ...
                  {tableData.map((data, index) => (
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        {formSubmitted && <div className="error-message">{tableDataErrors[index]?.columnName && "Column Name is required"}</div>}
                      ...
                      <td>
                        ...
                        {formSubmitted && <div className="error-message">{tableDataErrors[index]?.dataType && "Data Type is required"}</div>}
                      ...
                      <td>
                        ...
                        {formSubmitted && <div className="error-message ">{tableDataErrors[index]?.nullable && "Nullable is required"}</div>}
